...
<div class="form-box">
    ...
    <table>
        ...
        <tr>
            <td>Nama</td>
            <td>:</td>
            <td><input type="text" name="nama" class="input-wide"
                    value="<?= htmlspecialchars($data["nama"] ?? "") ?>" /></td>
        </tr>
        <tr>
            <td>Kelas</td>
            <td>:</td>
        ...
        <tr>
            <td>Alamat</td>
            <td>:</td>
            <td><textarea name="alamat" class="input-wide"
                    rows="3"><?= htmlspecialchars($data["alamat"] ?? "") ?></textarea></td>
        </tr>
        <tr>
            <td>Kota</td>
            <td>:</td>
            <td><input type="text" name="kota" style="width:180px;"
                    value="<?= htmlspecialchars($data["kota"] ?? "") ?>" /></td>
        </tr>
        <tr>
            <td>Jenis Kelamin</td>
            <td>:</td>
